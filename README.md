...
Maximum/Minimum temperature plays a key role in the variation of season changes. Hence, the following figure depicts the heat anomalies across Australia from 1994 to 2024 (Temperature_variation.Rmd). Download the data from SILO website if you want to reproduce the plot below. 
...
* Columns: Death count
 ...
 The violin plots given below compares the mortality distributions for Females and Males across three sites for 2014 - 2018 and  2019 - 2023 (mortality_risk.Rmd). 
