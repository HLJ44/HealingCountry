...
data
df <- data.frame(Date = data$Date,Temperature = data$T.Max) 
write.csv(df, file="circular_temp_tennant.csv")
```
...
data
df <- data.frame(Date = data$Date,Temperature = data$T.Max) 
write.csv(df, file="circular_temp_lismore.csv")
...
data <- process_data_LP(location)
data
write.csv(df, file="circular_temp_perth.csv")
