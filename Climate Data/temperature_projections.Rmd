---
title: "Temperature Scenario Projections"
...
write.csv(projections, file = "temperature_projections.csv")
```
...
```{r}
p <- ggplot() +
  geom_line(data = df, aes(x = Year, y = Avg_Temp), color = "black", size = 1) +
  labs(
