...
df <- df %>%
  mutate(
    RR_WA = scale(WA),
    Heat_z_WA = scale(WA_Heat_Anomalies)[,1]
  )
...
ggplot(df, aes(x = Year)) +
  ...
  labs(
    title = "Age-Standardised Relative Risk of Suicide in WA",
    y = "Relative Risk",
    x = "Year",
    colour = "Legend"
  ) +
...
ggplot(df, aes(x = Year)) +
  ...
  labs(
    title = "Age-Standardised Relative Risk of Suicide in NSW",
    y = "Relative Risk",
    x = "Year",
    colour = "Legend"
  ) +
...
ggplot(df_new, aes(x = Year)) +
  ...
  labs(
    title = "Age-Standardised Relative Risk of Suicide in NT",
    y = "Relative Risk",
    x = "Year",
    colour = "Legend"
  ) +
